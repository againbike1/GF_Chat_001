...
#warning ----- 16.3.21 给TabBarView添加了背景颜色
        self.tabBarView.backgroundColor = [UIColor colorWithPatternImage:[[UIImage imageNamed:@"customerBarBg"] stretchableImageWithLeftCapWidth:10 topCapHeight:0]];
...
-(void)createUI{
    ...
    for (int i = 0; i < self.unSelectedImages.count; i ++) {
        ...
        [button setImage:self.selectedImages[i] forState:UIControlStateHighlighted];
